...
class _LaporCepatPageState extends State<LaporCepatPage> {
  ...
  Future<void> _loadAddressFromLatLng(lat_lng.LatLng point) async {
    if (!mounted) return;
  ...
  InputDecoration _dec(String hint, bool enabled) {
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: required
                ...
                : null,
            decoration: _dec(hint ?? "Ketik $label...", enabled),
          ),
        ],
      ),
    );
  ...
  Future<void> _initUserLocation() async {
    try {
      ...
      await _loadAddressFromLatLng(_selectedLatLng!);
    } catch (e) {
  ...
  Future<void> _searchLocation() async {
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        if (_address == null) {
          await _loadAddressFromLatLng(point);
        }
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _goToMyLocation() async {
    ...
    await _loadAddressFromLatLng(_userLatLng!);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Laporan Kejahatan Cepat'),
        centerTitle: true,
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            _field(
              _judulController,
              label: "Judul Kejahatan",
              hint: "Contoh: Tawuran pelajar di jembatan...",
              // icon: Icons.title,
              required: true,
            ),
            ...
            _field(
              ...
              label: "Deskripsi",
              hint: "Ceritakan singkat kronologi kejadian...",
                      ...
                      child: FlutterMap(
                        ...
                        options: MapOptions(
                          ...
                          onTap: (_, latlng) async {
                            ...
                            await _loadAddressFromLatLng(latlng);
                          },
                        ),
                        children: [
                          TileLayer(
            ...
            if (_selectedLatLng != null) ...[
              ...
              Text(
                'Koordinat: ${_selectedLatLng!.latitude.toStringAsFixed(5)}, ${_selectedLatLng!.longitude.toStringAsFixed(5)}',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(_submitting ? 'Mengirim...' : 'Kirim Laporan'),
              ),
            ),
