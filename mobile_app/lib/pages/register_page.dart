...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _registerUser() async {
    ...
    if (nikController.text.isEmpty ||
        ...
        passwordController.text.isEmpty ||
        confirmPasswordController.text.isEmpty) {
      _showSnack("Lengkapi semua data wajib terlebih dahulu");
      return;
    }
    ...
    if (_ktpImage == null) {
      _showSnack("Silakan foto KTP terlebih dahulu");
      return;
    }
    ...
    if (_selectedRole == 'officer') {
      if (nrpController.text.isEmpty ||
          pangkatController.text.isEmpty ||
          satuanController.text.isEmpty) {
        _showSnack("NRP, Pangkat, dan Satuan wajib diisi untuk officer");
        return;
      }

      if (_buktiOfficerImage == null) {
        _showSnack("Silakan foto bukti bahwa Anda petugas");
        return;
      }
    }
    ...
    setState(() {
      _isSubmitting = true;
      _statusMessage = "Mengirim data registrasi...";
      _statusColor = isDark ? AppColors.textMuted : Colors.black87;
    });
  ...
  InputDecoration _fieldDecoration({
    ...
    return InputDecoration(
      ...
      fillColor: isDark
          ? AppColors.white05
          : (useSoftFill ? const Color(0xFFEAEAEA) : Colors.white),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        borderSide: BorderSide(
          color: isDark
              ? AppColors.borderLight2
              : (useSoftFill ? Colors.transparent : const Color(0xFFE0E0E0)),
        ),
      ),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(14),
        borderSide: BorderSide(
          color: isDark ? AppColors.primaryBlue : const Color(0xFF8B5A24),
          width: 1.2,
        ),
      ),
      border: OutlineInputBorder(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: isDark
                              ? AppColors.shadowDark.withOpacity(0.32)
